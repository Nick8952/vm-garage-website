...
| Quelle | Was sie liefert | Verlässlichkeit |
|---|---|---|
| **Handelsregister** (SHAB-Publikationen 01.03.2006, 23.03.2009, 11.09.2012, 03.12.2019; gespiegelt auf easymonitoring.ch, business-monitor.ch) | Firma, Rechtsform, UID CHE-112.785.667, Sitz Weststrasse 117/119, Gründung 23.02.2006, Zweck, Gesellschafter/Geschäftsführung | amtlich – **verwendet** |
...
| Inhalt | Quelle | Zielseite | Status |
|---|---|---|---|
...
| «Ersatzwagen stehen zur Verfügung» | alte Website (2013) | Leistungen, Startseite (Fakten) | übernommen, **vom Kunden zu bestätigen** |
...
4. **Leistungsumfang** stammt aus 2013 – ob Abgaswartung, Lenkgeometrie, Occasionshandel und Ersatzwagen heute noch angeboten werden, ist zu bestätigen.
5. **Alte Website** ist offline; ob die Domain vm-garage.ch noch dem Kunden gehört (für einen späteren Umzug), ist beim Kunden/Registrar zu klären.
6. Kein aktuelles Bildmaterial, kein Logo, keine Öffnungszeiten, keine E-Mail-Adresse → siehe docs/UEBERGABE.md, «Offene Unternehmensangaben».
